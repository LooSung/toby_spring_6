...
@ExtendWith(SpringExtension.class) @ContextConfiguration(classes = OrderConfig.class) public class OrderServiceSpringTest {
	...
	@Test void crateOrder() {
		var order = orderService.createOrder("0010", BigDecimal.ONE);

		Assertions.assertThat(order.getId()).isGreaterThan(0);
	}

	@Test void createOrders() {
		List<OrderReq> orderReqs = List.of(new OrderReq(("0200"), BigDecimal.ONE), new OrderReq(("0300"), BigDecimal.TEN));
	...
	@Test void createDuplicatedOrders() {
